...
if __name__ == '__main__':
    ...
    for pdf_i, pdf in enumerate(pdfs):
        ...
        #TODO deletar o arquivo xml deste arquivo da pasta dos xml!
        for i, image_path in enumerate(tqdm(images)):
            ...
            # xml_path = os.path.join(args.xml, pdf_name + '.xml')

            # if not os.path.exists(args.xml):
            #     os.makedirs(args.xml)  # Create the directory if it doesn't exist
            ...
            if os.path.exists(grid):
                ...
                for j in range(len(output)):
                    ...
                    if output[j].pred_classes.item() == image_label[args.dataset]:
                        ...
                        sub_type = ''
                        element_text = ''
                        #TODO o que fazemos com as tabelas?
                        ...
                        #     except Exception:
                        #         # Verifica se a pasta de erros existe
                        #         error_dir = os.path.join(args.output, "erros")
                        #         if not os.path.exists(error_dir):
                        #             os.mkdir(error_dir)
                                
                        #         # Move o arquivo que deu erro para a pasta correta
                        #         os.rename(crop_path, os.path.join(error_dir, f"{pdf_name}_{page}_box{j}.png")) 
        ...
        #     print(f"Deletando: {directory_path}")
        #     shutil.rmtree(directory_path)
        # else:
        #     print(f"{directory_path} não existe")
